                           ...
                           uint32_t seed, void * out )
{
  ...
  for(int i = -nblocks; i; i++)
  {
    uint32_t k1 = jl_load_unaligned_i32(data + sizeof(uint32_t)*(i*4 + 0));
    uint32_t k2 = jl_load_unaligned_i32(data + sizeof(uint32_t)*(i*4 + 1));
    uint32_t k3 = jl_load_unaligned_i32(data + sizeof(uint32_t)*(i*4 + 2));
    uint32_t k4 = jl_load_unaligned_i32(data + sizeof(uint32_t)*(i*4 + 3));
